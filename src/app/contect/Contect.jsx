...
const NovotionContact = () => {
  ...
  const locations = [
    {
      ...
      icon: '🇺🇸',
      mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.536168588547!2d-81.47168!3d28.45668!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDI3JzI0LjEiTiA4McKwMjgnMTguMSJX!5e0!3m2!1sen!2sus!4v1234567890'
    },
    {
      id: 'india',
      name: 'India Office',
      ...
      icon: '🇮🇳',
      mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.9876543!2d72.51234!3d23.01234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDAwJzQ0LjQiTiA3MsKwMzAnNDQuNCJF!5e0!3m2!1sen!2sin!4v1234567890'
    }
  ];
  ...
  return (
    <div className="bg-white overflow-x-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className={`text-center transform transition-all duration-1000 ${isVisible.hero ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
              Contact <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent animate-pulse">Us</span>
            </h1>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-4xl mx-auto">
            {contactMethods.map((method, idx) => (
              <a
                key={method.title}
                href={method.link || '#'}
                className={`group bg-white rounded-xl p-4 shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 overflow-hidden text-center ${isVisible.methods ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
              ...
              >
                ...
                <p className="text-xs text-gray-600 break-words leading-tight">{method.value}</p>
              </a>
            ))}
          </div>
        </div>
      ...
      <section ref={setRef('main')} className="py-12 bg-slate-50 min-h-[80vh] flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
            {/* Contact Form */}
            <div className={`transform transition-all duration-1000 delay-200 ${isVisible.main ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            ...
            <div className={`transform transition-all duration-1000 delay-400 ${isVisible.main ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-xl">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4 text-sm">
                    Ready to take your recruitment strategy to the next level? Get in touch with us today.
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a href="tel:+17866523950" className="group bg-white rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center transform hover:-translate-y-1">
                  ...
                  <a href="mailto:info@novotionservices.com" className="group bg-white rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 text-center transform hover:-translate-y-1">
                    <div className="w-8 h-8 bg-blue-500/10 rounded-lg flex items-center justify-center text-blue-600 mb-2 mx-auto group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <span className="text-xs font-semibold text-gray-900">Email Us</span>
                  </a>
                </div>
              </div>
            </div>
      ...
      <section ref={setRef('locations')} className={`py-12 ${BRAND_COLORS.dark.bg} min-h-[80vh] flex items-center`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-8 transform transition-all duration-1000 ${isVisible.locations ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          {/* Location Tabs */}
          <div className={`flex justify-center gap-3 mb-8 transform transition-all duration-1000 delay-200 ${isVisible.locations ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto transform transition-all duration-1000 delay-400 ${isVisible.locations ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            {/* Map */}
              ...
              {locations.map((location) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center text-lg flex-shrink-0 shadow-lg`}>
                      {location.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        href={`https://maps.google.com/?q=${encodeURIComponent(location.address)},${encodeURIComponent(location.city)}`}
                        target="_blank"
      ...
      <section ref={setRef('cta')} className={`py-12 ${BRAND_COLORS.dark.bg} min-h-[50vh] flex items-center`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center max-w-3xl mx-auto transform transition-all duration-1000 ${isVisible.cta ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
              Ready to Transform Your Business?
            </h2>
            <p className="text-blue-100 text-sm mb-6 leading-relaxed">
              Join over 500 global clients who trust Novotion for their BPO needs.
            </p>
