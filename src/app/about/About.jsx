...
const StatCard = ({ number, suffix, label, visible, delay, dark = false }) => (
  <AnimatedCard delay={delay} className={`${dark ? 'bg-white/10 backdrop-blur-md border-white/20' : 'bg-slate-900/5 border-gray-200'} px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-500`}>
      ...
      <section ref={setRef('vision')} className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <AnimatedCard delay={200} className="group bg-slate-50 rounded-2xl p-6 sm:p-8 lg:p-10 transform transition-all duration-1000 delay-200 hover:scale-105">
            ...
            <AnimatedCard delay={400} className="group bg-slate-50 rounded-2xl p-6 sm:p-8 lg:p-10 transform transition-all duration-1000 delay-400 hover:scale-105">
