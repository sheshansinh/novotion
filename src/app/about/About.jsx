...
const NovotionAbout = () => {
  ...
  const coreValues = [
    {
      title: 'Excellence',
      description: 'Quality of work does not stop at competence but goes beyond clients\' expectations.',
      icon: '⭐',
      color: 'from-yellow-400 to-amber-500'
    },
    {
      title: 'Commitment',
      description: 'The dedication of our team extends beyond the good of the company, to the betterment and success of our clients by allocating the required resources and training to exceed your goals.',
      icon: '💪',
      color: 'from-green-500 to-emerald-600'
    },
    {
      title: 'Integrity',
      description: 'Novotion only believes in doing work the right way with the right attitude and motivation.',
      icon: '🔒',
      color: 'from-blue-500 to-cyan-600'
    },
    {
      title: 'Innovation',
      description: 'The call center industry is fast-paced and ever-changing. With Novotion, you are assured that you are never left behind.',
      icon: '🚀',
  ...
  const journeySteps = [
    {
      year: '2021',
      title: 'Foundation',
      description: 'Novotion was founded with a vision to revolutionize BPO services',
      icon: '🏁'
    },
    {
      year: '2022',
  ...
  return (
    <div className="bg-white overflow-x-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className={`text-center transform transition-all duration-1000 ${isVisible.hero ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
              Leading business process outsourcing with a global presence since 2021
            </p>
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              <StatCard number={500} suffix="+" label="Global Clients" visible={isVisible.hero} delay={200} dark />
              <StatCard number={3} suffix="" label="Countries" visible={isVisible.hero} delay={400} dark />
              <StatCard number={2021} suffix="" label="Founded" visible={isVisible.hero} delay={600} dark />
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={setRef('overview')} className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className={`relative transform transition-all duration-1000 delay-200 ${isVisible.overview ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            ...
            <div className={`transform transition-all duration-1000 delay-400 ${isVisible.overview ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Trusted BPO Partner <span className="text-blue-800">Since 2021</span>
              </h2>
              <div className="space-y-4 text-gray-600 text-base sm:text-lg leading-relaxed">
                <p className="relative pl-4 border-l-4 border-blue-500">
                  Founded in 2021, Novotion is a leading business process outsourcing (BPO) company with a strong presence in the <span className="font-semibold text-blue-800">USA, UK, and India</span>. As a trusted partner in the outsourcing industry, Novotion serves a diverse global clientele of over 500 clients across various sectors and regions.
                </p>
                <p className="relative pl-4 border-l-4 border-blue-600">
                  As an <span className="font-semibold text-blue-800">e-Verified company</span>, Novotion demonstrates its commitment to maintaining rigorous standards in data security and operational excellence.
                </p>
                <div className="pt-6">
                  <div className="inline-flex items-center gap-3 bg-slate-900/5 px-6 py-4 rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    ...
                    <span className="text-blue-800 font-bold text-lg">e-Verified Company</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 sm:mb-20 transform transition-all duration-1000 ${isVisible.journey ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              From humble beginnings to global recognition - our story of growth and innovation
            </p>
          </div>
      ...
      <section ref={setRef('solutions')} className={`py-16 sm:py-20 lg:py-24 ${BRAND_COLORS.dark.bg}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className={`order-2 lg:order-1 transform transition-all duration-1000 delay-200 ${isVisible.solutions ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                Comprehensive <span className="text-blue-400">B2B & B2C</span> Solutions
              </h2>
              <div className="space-y-4 text-blue-100 text-base sm:text-lg leading-relaxed mb-8">
                <p>
                  Novotion INC specializes in a comprehensive range of B2B and B2C services, including outbound call center solutions for lead generation, upselling, cross-selling, and sales support, as well as inbound call center services for phone answering, back office support, and order processing.
                </p>
                <p>
                  We empower businesses to grow and engage with their target markets through multiple channels.
                </p>
              </div>
              
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                {['Voice', 'Email', 'Social Media', 'Chat', 'Web', 'SMS'].map((channel, idx) => (
                  <div 
                    key={channel}
                  ...
                  >
                    ...
                    <div className="relative text-blue-200 group-hover:text-white font-semibold text-center text-sm transition-colors duration-300">{channel}</div>
                  </div>
                ))}
              </div>
            </div>

            <div className={`order-1 lg:order-2 transform transition-all duration-1000 delay-400 ${isVisible.solutions ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="group rounded-2xl overflow-hidden shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-900 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-4">
                        <p className="text-white font-semibold text-sm">Call Center Excellence</p>
                      </div>
                    </div>
                    <div className="group rounded-2xl overflow-hidden shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      <img 
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-800 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-4">
                        <p className="text-white font-semibold text-sm">Customer Support</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-3 sm:space-y-4 pt-8 sm:pt-12 lg:pt-16">
                    ...
                    <div className="group rounded-2xl overflow-hidden shadow-xl transform hover:scale-105 transition-transform duration-500 relative">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-blue-600 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-300 flex items-end p-4">
                        <p className="text-white font-semibold text-sm">Professional Workspace</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section ref={setRef('industries')} className="py-16 sm:py-20 lg:py-24 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-12 sm:mb-16 transform transition-all duration-1000 ${isVisible.industries ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Our expertise extends across various sectors with specialized solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4 lg:gap-5">
            {industries.map((industry, idx) => (
              <div
                key={industry.name}
                className={`group relative bg-white rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 transition-all duration-300 border border-gray-100 overflow-hidden ${isVisible.industries ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="text-2xl sm:text-3xl lg:text-4xl mb-2 sm:mb-3 lg:mb-4 text-center transform group-hover:scale-125 transition-transform duration-300">{industry.icon}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className={`group bg-slate-50 rounded-2xl p-6 sm:p-8 lg:p-10 transform transition-all duration-1000 delay-200 hover:scale-105 ${isVisible.vision ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center lg:text-left">
                Our vision is to be one of the most reliable and trusted business process outsourcing Services providers. We will continuously strive for success and enhance our brand conception worldwide.
              </p>
            </div>
            ...
            <div className={`group bg-slate-50 rounded-2xl p-6 sm:p-8 lg:p-10 transform transition-all duration-1000 delay-400 hover:scale-105 ${isVisible.vision ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center lg:text-left">
                Our mission is to empower our clients by providing innovative, cost-effective, and high-quality BPO solutions that enable them to achieve their business objectives with efficiency and excellence.
              </p>
            </div>
          </div>
        </div>
